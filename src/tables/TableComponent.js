...
function TableComponent({ tableType, columns, dataFromWS }) {
  switch (tableType) {
    case "market_data":
      break;
    case "pnl_monitor":
      console.log("hereeee");
      return (
        <PnlMonitor type={tableType} data={dataFromWS} columns={columns} />
      );
    case "intraday_monitor":
      return (
        <IntradayMonitor type={tableType} data={dataFromWS} columns={columns} />
      );
    default:
      break;
  }
